...
## 👋 About Me
I am a highly motivated software engineer with experience in full-stack, front-end, and back-end development for diverse industries, including IoT, medical imaging, social media, and virtual health. This includes professional, hands-on experience in designing, developing, implementing, and enhancing innovative products, services, and platforms for internal and external users.

In addition, I have completed numerous independent projects to hone my skills in building apps and games to continuously explore new technologies and languages. My attention to detail ensures full alignment with stakeholder requirements, schedules, and deadlines.

I hold a dual Bachelor of Software Engineering & Bachelor of Electrical Engineering from the University of Calgary, where I completed extensive coursework in distributed systems, operating systems, algorithms & data structures, networks, computer architecture, machine learning, circuits, logic design, signal processing, data science, database design, computer graphics, and FPGA design.

Always open to growing my network, I welcome connections from other software engineers. Thank you for visiting my profile.


## 🚀 Experience
- Built production-grade software in high-stakes environments (medical imaging, IoT, and more) without (completely) losing my sanity.  
- Spent countless hours debugging code—fueled by coffee, the occasional snack, and sheer determination.  
- Proudly shipped features that my younger self never would’ve believed possible.  

<!-- SKILLS SECTION -->
## 🛠️ Technologies & Skills

**Proficient**: C++, Python, Unix, Git, ROS, JavaScript, Algorithms & Data Structures, TensorFlow, React, Bash, APIs, Embedded Systems, Docker, Git, VHDL, DynamoDB, CMake, MATLAB, Django, TeamCity, MapReduce, Hadoop, Spark
...
### 2. Pulse Fitness (Wearable Fitness Device)
**Languages & Technologies:**  
...
### 3. Adaptive AMC: Early-Exiting AMC with TAD Denoiser & SNR Predictor
**Languages & Technologies:**  
...
### 6. Precision Parking (Ultrasonic Parking Sensor)
**Languages & Technologies:**  
...
[<img align="left" alt="[Your Name] | Personal Website" width="22px" src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/googlechrome.svg" />][website]
